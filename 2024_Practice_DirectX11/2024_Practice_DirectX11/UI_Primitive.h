...
protected:
	...
	//ç≈èâÇÃëÂÇ´Ç≥ÇãLò^ÇµÅAviewportïœâªÇ∑ÇÈÇ∆Ç´Ç…ëÂÇ´Ç≥ÇïœâªÇµÇ»Ç¢ÇÊÇ§Ç…
	DirectX::XMFLOAT2 mOriginScale = {1.0f,1.0f};
	DirectX::XMFLOAT2 mOriginPos = {};

	bool isDefShader = true;
	bool isUseUVAnimation = false;//UVAnimationÇégÇ§Ç©
...
public:
	...
	*/
	...
	/// @brief Default ShaderÇ…égÇÌÇÍÇÈÉfÅ[É^ÇÃèëÇ´çûÇ›
