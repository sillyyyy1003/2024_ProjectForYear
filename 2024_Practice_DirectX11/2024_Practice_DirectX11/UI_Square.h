...
public:
	...
	void Init(const char* _fileName = nullptr, int slices = 0 , DirectX::XMINT2 _split = { 1,1 });
	void Init(const std::shared_ptr<Texture>& tex, int slices = 0, DirectX::XMINT2 _split = { 1,1 });
